...
(function () {
  ...
  const DEFAULT_DECK = Object.freeze([
    ...
    { t: "Reality Check", b: "Most font disputes resolve with a demand letter and retroactive licensing, not a lawsuit. A vendor flags out-of-scope use (extra installs, self-hosted web beyond the tier, app embeds, vendor sharing), shares evidence (URLs, dates, crawler logs), and proposes a “true-up” for the past period plus proper licensing going forward—or removal/replacement. Teams usually negotiate scope and fees, document fixes, and close it out. Court is the exception, typically reserved for large, willful, or unresolvable cases." },
    { t: "Tip", b: "Track seats and scope per channel so you always know what’s covered: Desktop = installs/users (machines), Web = domains + monthly page views + hosting method, App = explicit embed rights per title/version (or MAU), Broadcast = time/region/placement limits, Server = instance count and render volumes. Keep a simple ledger tying each family to who/where/how it’s used (including vendors) so true-ups, audits, and renewals are straightforward." },
    ...
    { t: "Fun Fact", b: "In the 1990s, Microsoft commissioned a team to design Arial as a “metrics-compatible” twin of Helvetica. Because the shapes themselves couldn’t be copyrighted, Microsoft could sell a Helvetica lookalike bundled with Windows—skirting licensing fees while keeping document layouts identical." },
    { t: "Fun Fact", b: "In the EU and UK, the visual appearance of a typeface can be protected as an industrial design. In the EU, a Registered Community Design can last up to 25 years (renewed in 5-year blocks), while an Unregistered Community Design gives 3 years from first disclosure. The UK offers similar protection through Registered Designs and specific design provisions for typefaces. These rights target the look/overall impression (not the font software), so independent creation is a defense—and you still need a license for the font file you use." },
    { t: "Fun Fact", b: "Comic Sans was drawn in 1994 by Microsoft designer Vincent Connare after he saw Microsoft Bob’s speech bubbles set in Times New Roman. He sketched a friendlier UI font inspired by comic books—specifically The Dark Knight Returns and Watchmen. It missed Bob’s ship date but debuted in the Windows 95 Plus! Pack (and apps like 3D Movie Maker). Coincidentally, it's design was easier to read for those with dyslexia and inspired the creation of fonts like Dyslexie and OpenDyslexic." },
    { t: "Fun Fact", b: "Impact — Geoffrey Lee (1965) built it to be ink-heavy and space-efficient—a headline hammer for tight columns. Bundled on millions of PCs, it later became the unmistakable voice of internet image macros: loud, condensed, white-on-black stroke, punchline delivered." },
    { t: "Fun Fact", b: "Papyrus — Chris Costello hand-drew it in 1982, imagining what an ancient script might look like in print. Decades later it caught wildfire via broad distribution—then pop-culture infamy with Avatar and an SNL sketch—proof that ubiquity can turn any font into a meme." },
    { t: "Fun Fact", b: "Helvetica — Born in 1957 as Neue Haas Grotesk (Max Miedinger with Eduard Hoffmann), it was renamed Helvetica a few years later (from Helvetia, Latin for Switzerland) to boost international appeal. Its calm neutrality made it the go-to for transit systems, corporations, and anyone who wanted typography to whisper “modern” without shouting." },
    { t: "Fun Fact", b: "Times New Roman — Commissioned in 1931 for The Times of London, directed by Stanley Morison and drawn by Victor Lardent. It squeezed more legible text per line on cheap newsprint, which is why it still feels efficient and serious—like a perfectly pressed suit crammed with footnotes." },
    { t: "Fun Fact", b: "Georgia — Created by Matthew Carter (1993) for early screens, with Tom Rickner’s hinting wizardry. Big x-height, sturdy serifs, and warm curves made Georgia read beautifully at 12px on CRTs—proof that “web-safe” could also be charming." },
    { t: "Fun Fact", b: "Verdana — Also by Matthew Carter (1996) with expert hinting, Verdana is the humanist sans built for tiny pixels. Generous spacing, open counters, and distinctive letterforms (I/l/1) made it the UI sidekick of the dial-up era—and still a model for legibility." },
    { t: "Fun Fact", b: "Trajan — Carol Twombly (1989) traced the majestic Roman capitals of Trajan’s Column; the result has no lowercase and tons of gravitas. Movie posters loved it because it shouts “timeless epic”—instant red-carpet energy in a headline." },
    { t: "Fun Fact", b: "Cooper Black — Drawn in 1922 by Oswald Bruce Cooper, this soft-edged, ultra-bold serif became the original “friendly loud.” From 1960s album covers to today’s packaging, its pudding-thick curves are vintage comfort food for the eyes." },
    { t: "Fun Fact", b: "Gotham — Tobias Frere-Jones distilled mid-century New York signage into a clean, geometric sans (2000). It became the face of the Obama 2008 campaign and a branding staple: approachable, American, and impeccably kerneled." },
    { t: "Fun Fact", b: "Calibri — Designed by Lucas de Groot, Calibri replaced Times New Roman as the Microsoft Office default in 2007, nudging the world toward a friendlier sans. In 2023, Microsoft crowned Aptos as the new default, moving the baseline again for millions of documents." },
  ]);
...
(function(){
  const data = [
    ...
    { h: "Scarcity as de facto protection",
      b: "Copying rival letters wasn’t drag-and-drop; it was slow, specialized, and capital-intensive. That friction deterred casual imitation and functioned like a practical barrier long before modern licensing and software rights existed." },
