# How AI Works (Without the Hype): Marketing Potluck Project Management Edition (V4)
...
## Micro-Glossary: Seven Terms You’ll See a Lot
...
* **Randomness (temperature)**: how much variation you may see if you run the same prompt multiple times
...
Even with the same prompt, many AI systems introduce some **randomness** when choosing the next token. Practically, that means:
