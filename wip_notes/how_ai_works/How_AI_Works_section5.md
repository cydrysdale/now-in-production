...
* **Pipeline panel:** Ticket Card → Prep Counter → Tool icons → Plate → Expo Pass gate → “SERVE”
* **Four taste-tests:** A 4-icon checklist (ticket, receipt, mirror, corner-case)
