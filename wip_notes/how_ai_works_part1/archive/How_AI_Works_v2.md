Below is a **V2 draft** incorporating the review notes (glossary added; tightened mental-model language; reduced repeated “kid/work” scaffolding; interactive callouts consolidated; added training-vs-tools clarity; improved prompt ladder spec; fixed table normalization example; and cleaned the “Reference files” ending).

---

# How AI Works (Without the Hype): Marketing Potluck Project Management Edition (V2)
...
## Micro-glossary (five terms you’ll see a lot)
...
```text
Normalized intake row (example):
- Category: Location
- Item: Confirm final location; Atrium cannot be used (Finance offsite); Conf Room B may be booked; Kitchen is in Invite #1.
- Evidence: C, D, E, I, L
- Needs_clarification: Yes
- Confidence: High (about Atrium being unavailable), Low (about final location decision)
```
...
|  4 | Location         | Confirm final location (Kitchen vs Conf Room B vs Atrium). Atrium is unavailable.  | C, D, E, I, L | Unassigned | Unknown | Finance + Facilities              | Space unavailable; safety issues           | Yes                 | High (Atrium), Low (final choice) | None                          |
|  5 | Safety           | Severe nut allergy: define nut-free policy + cross-contamination handling.         | A, F, L       | Unassigned | Unknown | Raj guidance + comms owner        | Health risk                                | Yes                 | High                              | None                          |
|  6 | Policy           | HR: participation voluntary; avoid pressure; no alcohol at lunch.                  | H             | Unassigned | Unknown | Messaging owner                   | “Mandatory fun” backlash; policy violation | No                  | High                              | None                          |
...
|  9 | Labeling         | Create label template for allergens + heat level.                                  | A, D, F       | Becky      | Unknown | None noted                        | Allergy/complaints if missing              | No                  | High                              | Becky already has template    |
| 10 | Labeling         | Enforce labeling + update sign-up doc fields to require allergens + heat level.    | A, D, F       | Unassigned | Unknown | DRI + Becky template              | Labeling inconsistency                     | Yes                 | High                              | None                          |
...
| 13 | Menu conflict    | “Dessert (almond flour?)” conflicts with nut allergy constraint.                   | F, A          | Unassigned | Unknown | Nut policy decision               | Allergy risk                               | Yes                 | High                              | Almond flour implies tree nut |
